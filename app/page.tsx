  ...
  export default function Home() {
    ...
    const fetchLargeDataRecharts = async () => {
      ...
      try {
        ...
        const response = await fetch('https://leandrology.github.io/databley/data.json')
        if (!response.ok) {
    ...
    const fetchSmallDataRecharts = async () => {
      ...
      try {
        const startTimeRecharts = performance.now();
        const response = await fetch('https://leandrology.github.io/databley/data2.json')
        if (!response.ok) {
          throw new Error(`Error fetching data: ${response.statusText}`);
        }
        const jsonData = await response.json();
    ...
    const fetchLargeDataNivo = async () => {
      ...
      try {
        ...
        const response = await fetch('https://leandrology.github.io/databley/data3.json')
        if (!response.ok) {
          throw new Error(`Error fetching data: ${response.statusText}`);
        }
        const jsonData = await response.json();
    ...
    const fetchSmallDataNivo = async () => {
      ...
      try {
        const startTimeNivo = performance.now();
        const response = await fetch('https://leandrology.github.io/databley/data4.json')
        if (!response.ok) {
          throw new Error(`Error fetching data: ${response.statusText}`);
        }
        const jsonData = await response.json();
    ...
    const fetchSmallDataGoogleChart = async () => {
      ...
      try {
        ...
        const response = await fetch('https://leandrology.github.io/databley/data7.json')
        if (!response.ok) {
          throw new Error(`Error fetching data: ${response.statusText}`);
        }
        const jsonData = await response.json();
    ...
    const fetchLargeDataGoogleChart = async () => {
      ...
      try {
        const startTimeGoogleChart = performance.now();
        const response = await fetch('https://leandrology.github.io/databley/data8.json')
        if (!response.ok) {
          throw new Error(`Error fetching data: ${response.statusText}`);
        }
        const jsonData = await response.json();
